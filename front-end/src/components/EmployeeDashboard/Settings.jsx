...
const Settings = () => {
    ...
    const PasswordToggle = ({ show, onClick }) => (
        <button
            type="button"
            onClick={onClick}
            className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
            tabIndex={-1}
    ...
    const inputClasses = (hasError, isValid) =>
        `w-full border bg-blue-50/40 dark:bg-gray-700/50 rounded-xl px-4 py-2.5 pr-12 text-sm text-gray-700 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 transition-all ${
            hasError
    ...
    return (
        <div className="flex justify-center">
            <div className="w-full max-w-3xl space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-4 sm:p-8">
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="space-y-4 text-center max-w-sm mx-auto">
                            ...
                            <div>
                                ...
                                {passwordsMatch && (
                                    <p className="mt-1.5 text-xs text-emerald-500 flex items-center justify-center gap-1">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:from-gray-400 disabled:to-gray-500 text-white py-2.5 rounded-xl text-sm font-semibold shadow-lg transition-all duration-200 active:scale-[0.98] min-h-[44px]"
                        >
                            {loading ? (
                                <>
