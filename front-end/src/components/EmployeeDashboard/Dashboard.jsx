  ...
  return (
    <div className="w-full h-full flex flex-col bg-white dark:bg-gray-900">
      ...
      <nav className="flex flex-col gap-1 p-3 sm:p-4 flex-1 overflow-y-auto">
        <NavLink to="/employee-dashboard" end className={linkClasses} onClick={handleNavClick}>
          <DashboardIcon />
          Dashboard
        </NavLink>
        <NavLink to="/employee-dashboard/Profile" end className={linkClasses} onClick={handleNavClick}>
          <EmployeesIcon />
          My Profile
        </NavLink>
        <NavLink to="/employee-dashboard/Leaves" end className={linkClasses} onClick={handleNavClick}>
          <LeavesIcon />
          Leaves
        </NavLink>
        <NavLink to="/employee-dashboard/salary" end className={linkClasses} onClick={handleNavClick}>
          <SalaryIcon />
          Salary
        </NavLink>
        <NavLink to="/employee-dashboard/Settings" end className={linkClasses} onClick={handleNavClick}>
          <SettingsIcon />
          Settings
        </NavLink>
      </nav>
