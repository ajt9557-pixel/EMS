...
const AdminSummary = () => {
  ...
  const StatCard = ({ card }) => (
    <div className="relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm p-4 sm:p-5 group hover:shadow-md transition-shadow duration-200">
      ...
      <p className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider truncate pr-12">{card.label}</p>
