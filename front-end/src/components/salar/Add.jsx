            ...
            <div className="w-full max-w-3xl bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-600 mb-1.5">Basic Salary</label>
                            <input
                                type="number"
                                name="basicSalary"
                                onChange={handleChange}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-600 mb-1.5">Allowances</label>
                            <input
                                type="number"
                                name="allowances"
                                onChange={handleChange}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-600 mb-1.5">Deductions</label>
                            <input
                                type="number"
                                name="deductions"
                                onChange={handleChange}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-600 mb-1.5">Pay Date</label>
                            <input
                                type="date"
                                name="payDate"
                                onChange={handleChange}
